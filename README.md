...
| Admin server helpers | `resolveAdminServerId`, `guardSingleAdminRegistration`, `releaseAdminRegistration`, `ADMIN_SERVER_ID_ENV`                                                   | [Utilities Reference](./docs/UTILITIES.md#admin-server-helpers) |
