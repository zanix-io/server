...
Deno.test({
  ...
  fn: () => {
    ...
    defineProviderDecorator({ slot: 'public-test-core' })(PublicTestCoreProviderImpl as never)

    const viaName = PublicProgramModule.providers.get('public-test-core')
    const viaClass = PublicProgramModule.providers.get(PublicTestCoreProviderImpl)
...
Deno.test({
  ...
  fn: () => {
    ...
    defineConnectorDecorator({ slot: 'public-test-core' })(PublicTestCoreConnectorImpl as never)

    const viaName = PublicProgramModule.connectors.get('public-test-core')
    const viaClass = PublicProgramModule.connectors.get(PublicTestCoreConnectorImpl)
...
Deno.test({
  ...
  fn: () => {
    registerCoreProviderSlot('unresolved-test-provider-core', UnresolvedTestProviderBase, {
...
Deno.test({
  ...
  fn: () => {
    registerCoreProviderSlot('throwing-test-provider-core', UnresolvedTestProviderBase)
...
Deno.test({
  ...
  fn: () => {
    registerCoreConnectorSlot('unresolved-test-connector-core', UnresolvedTestConnectorBase, {
...
Deno.test({
  ...
  fn: () => {
    registerCoreConnectorSlot('throwing-test-connector-core', UnresolvedTestConnectorBase)
